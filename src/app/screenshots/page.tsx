...
function Shot({ title, subtitle }: { title: string; subtitle: string }) {
  return (
    <figure className="group rounded-3xl border border-white/8 bg-surface p-5 transition-all duration-200 ease-out hover:border-white/15 hover:-translate-y-0.5">
...
export default function ScreenshotsPage() {
  return (
    <>
      ...
      >
        <div className="mx-auto mb-10 max-w-3xl rounded-3xl border border-white/8 bg-surface p-6 text-center text-sm text-muted md:p-8">
          <div className="text-base font-semibold text-white">Screenshots coming soon</div>
          <div className="mt-2">
